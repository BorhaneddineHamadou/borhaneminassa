...
<html>
  <head>
    ...
    <link rel="stylesheet" href="css/after_sign.css">
  ...
  <body>
        ...
        <div class="first-header">
          <div class="container">
            <ul class="icons float-right classic-list clickDown">
              <li data-class="down"><img src="<?php echo $_SESSION['image'] ?>" class="responsive-image circle-image"><span style="color:white"><?php echo $_SESSION['username']?></span></li>
            </ul>
           <div class="sign float-left hidden-xs">
             <?php
                if($_SESSION['userrole']=='admin'){
                  echo '<a href="admin/index.php"><span>لوحة التحكم</span></a>';
                }elseif ($_SESSION['userrole']=='writer') {
                  echo '<a href="admin/writer.php"><span>لوحة التحكم</span></a>';
                }
              ?>
             <a href="profile.php?user=<?php echo $_SESSION['userid']; ?>"><span>الصفحةالشخصية</span></a>
           </div>
          </div>
        ...
        <section class="down">
          <section class="container">
            <ul class="classic-list  float-right">
              <?php
                 if($_SESSION['userrole']!='admin'){
                   echo '<a href="myforma.php" target="_blank"><li><span>الدورات المشترك بها<span></li></a>';
                 }
               ?>
              <a href="profile.php?user=<?php echo $_SESSION['userid']; ?>"><li class="hidden-sm hidden-md hidden-lg"><span>الصفحة الشخصية<span></li></a>
              <?php
                if($_SESSION['userrole']=='admin'){
                  echo '<a href="admin/index.php"><li class="hidden-sm hidden-md hidden-lg"><span>لوحة التحكم<span></li></a>';
                }elseif ($_SESSION['userrole']=='writer') {
                  echo '<a href="admin/writer.php"><li class="hidden-sm hidden-md hidden-lg"><span>لوحة التحكم</span></li></a>';
                }
               ?>
              <a href="logout.php?id=<?php echo $_SESSION['userid']; ?>"><li><span>تسجيل الخروج<span></li></a>
            </ul>
          </section>
        </section>
     ...
     <script src="js/after_sign.js"></script>
